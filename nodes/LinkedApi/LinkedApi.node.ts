...
const operations: Record<string, LinkedApiOperation> = {
	...
	retrieveConnectionRequests: new RetrieveConnectionRequests(),
	...
	acceptConnectionRequest: new AcceptConnectionRequest(),
	ignoreConnectionRequest: new IgnoreConnectionRequest(),
...
export class LinkedApi implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			...operations.retrieveConnectionRequests.operationFields,
			...
			...operations.acceptConnectionRequest.operationFields,
			...operations.ignoreConnectionRequest.operationFields,
