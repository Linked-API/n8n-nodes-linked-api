...
export const AVAILABLE_ACTION = {
	...
	adminGetSubscriptionPricing: 'adminGetSubscriptionPricing',
	adminGetBillingLink: 'adminGetBillingLink',
	adminCancelSubscription: 'adminCancelSubscription',
...
export const availableAdminOperations: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			value: AVAILABLE_ACTION.adminGetSubscriptionPricing,
			description: 'Get available subscription products and prices',
			action: 'Get subscription pricing',
		},
		{
			name: 'Get Billing Link',
			value: AVAILABLE_ACTION.adminGetBillingLink,
			description: 'Get Stripe billing portal link',
			action: 'Get billing link',
		},
		{
			name: 'Cancel Subscription',
			value: AVAILABLE_ACTION.adminCancelSubscription,
