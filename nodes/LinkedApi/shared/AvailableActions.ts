...
export const availableStandardOperations: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			value: AVAILABLE_ACTION.retrieveInvitations,
			description: 'Retrieve incoming invitations received by your account',
			action: 'Retrieve invitations',
		},
		{
		...
		},
		{
			...
			value: AVAILABLE_ACTION.acceptInvitation,
			description: 'Accept an incoming connection, company-follow, or newsletter invitation',
			action: 'Accept invitation',
		},
		{
			name: 'Ignore Invitation',
			value: AVAILABLE_ACTION.ignoreInvitation,
			description: 'Ignore an incoming connection, company-follow, or newsletter invitation',
